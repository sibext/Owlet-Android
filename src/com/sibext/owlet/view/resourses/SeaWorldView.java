...
/**
 * The sea set includes fish, star, shell and stone figure
 * 
 * @author Mike Osipov <osipov@sibext.com>
 * 
 */
public class SeaWorldView extends TaskImageViewFromResourse {
	/**
	 ...
	 */
	public SeaWorldView(Context context, Renderer renderer) {
